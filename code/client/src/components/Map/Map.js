...
class Map extends Component {
  ...
  componentDidMount() {
    ...
    legend.onAdd = function (map) {
      ...
      div.innerHTML += '<i style="background: orange"></i><span>30-40</span><br>';
      div.innerHTML += '<i style="background: yellow"></i><span>20-30</span><br>';
      div.innerHTML += '<i style="background: green"></i><span>10-20</span><br>';
      div.innerHTML += '<i style="background: darkgreen"></i><span>0-10</span><br>';
